...
$global_config['crossadmin_valid_domains'] = [0 => 'http://shop.mango.com', 1 => 'https://shop.mango.com', 2 => 'https://www.acfc.com.vn', 3 => 'http://www.acfc.com.vn'];
$global_config['crossadmin_valid_ips'] = [];
$global_config['crosssite_allowed_variables'] = [];
$global_config['crosssite_restrict'] = 1;
$global_config['crosssite_valid_domains'] = [0 => 'http://shop.mango.com', 1 => 'https://shop.mango.com', 2 => 'https://www.acfc.com.vn', 3 => 'http://www.acfc.com.vn'];
...
$global_config['ftp_user_pass'] = '4zqat0Im6ngQzhQ4fK3FUQ,,';
...
$global_config['my_domains'] = 'linhcavali.com';
...
$global_config['session_prefix'] = 'nv4s_u5U160';
...
$global_config['timestamp'] = 1678893020;
...
$nv_plugins = ['vi' => ['' => ['change_site_buffer' => [1 => [0 => 'includes/plugin/cdn_js_css_image.php', 1 => '', 2 => '2']], 'get_qr_code' => [1 => [0 => 'includes/plugin/qrcode.php', 1 => '', 2 => '1']]]], 'en' => ['' => ['change_site_buffer' => [1 => [0 => 'includes/plugin/cdn_js_css_image.php', 1 => '', 2 => '2']], 'get_qr_code' => [1 => [0 => 'includes/plugin/qrcode.php', 1 => '', 2 => '1']]]]];
